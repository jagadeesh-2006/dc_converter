      ...
      <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <h1 style={{ 
                ...
                color: 'transparent', 
                fontWeight: '800' 
              }}>Boolean Expression Converter</h1>
            </div>
            <div style={{ marginTop: '8px', color: '#94a3b8', fontSize: 'clamp(12px, 3vw, 14px)' }}>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          {mode === 'expr' ? (
            ...
            <TruthTableEditor 
              initialVars={[...new Set((expr.match(/[A-Za-z_]\w*/g) || []).slice(0, 5))] || ['A', 'B']} 
              initialRows={null} 
              onChange={(data) => { 
                if (data && data.error) { 
                  setError(data.error); 
              ...
              <div style={{ minWidth: 0, overflow: 'hidden' }}>
                ...
                {result.simplifiedExpr && (
                  <div style={{ 
                    ...
                    padding: '14px', 
                    borderRadius: '12px', 
                    background: 'linear-gradient(135deg, rgba(20,20,40,0.6), rgba(10,10,20,0.6))', 
        ...
        <footer style={{ 
          ...
          <div style={{ fontSize: 'clamp(12px, 3vw, 14px)' }}>
            Variables: <strong style={{ color: '#38bdf8' }}>A-E</strong> (max 5) • NOT: <strong style={{ color: '#38bdf8' }}>~</strong> • AND: <strong style={{ color: '#38bdf8' }}>&</strong> • OR: <strong style={{ color: '#38bdf8' }}>|</strong> • XOR: <strong style={{ color: '#38bdf8' }}>^</strong>
          </div>
        </footer>
      </div>
    </main>
